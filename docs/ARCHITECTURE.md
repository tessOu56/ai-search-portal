...
架構說明已整理至 **docs/** 目錄，以利與 specs 分層一致、方便 coding agent 與人查閱。

- **總覽**（Tech stack、目錄結構、Data Flow、Quality Gates）：[docs/architecture/system-overview.md](architecture/system-overview.md)
