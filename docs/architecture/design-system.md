...
- **單一來源**：顏色、間距、元件 API 以 [DESIGN_SYSTEM.md](../DESIGN_SYSTEM.md) 與 `app/components/ui/*` 為準。
...
- [DESIGN_SYSTEM.md](../DESIGN_SYSTEM.md)：Design tokens、Core components、Usage guidelines、LUI copy style
